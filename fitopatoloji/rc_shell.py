...
class RibbonBar(ttk.Frame):
    ...
    def _build(self):
        specs = [
            ...
            ("YARDIM", [
                ("Uygulama", [("? Yardım", "help", True), ("⚙ Ayarlar", "settings", False), ("ⓘ Hakkında", "about", False)]),
...
class AboutDialog(tk.Toplevel):
    def __init__(self, master):
        ...
        ttk.Label(frame, text="Sürüm {} — Release Candidate 1".format(APP_VERSION), style="Muted.TLabel").pack()
        ...
        ttk.Label(frame, text="2.0 RC1; yeni komut şeridi, akıllı kayıt önerileri, tutarlı uygulama kimliği ve sağlamlaştırılmış açılış deneyimini içerir.", style="Surface.TLabel", wraplength=430, justify="center").pack()
...
class SplashScreen(tk.Toplevel):
    def __init__(self, master):
        ...
        canvas.create_text(157, 112, text="Bilimsel Masaüstü • 2.0 RC1", anchor="w", fill="#b9cad8", font=("Segoe UI", 11))
